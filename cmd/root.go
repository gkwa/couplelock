...
import (
	...
	"github.com/gkwa/couplelock/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.couplelock.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".couplelock")
	}
